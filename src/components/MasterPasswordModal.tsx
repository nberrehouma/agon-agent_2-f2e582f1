...
export function MasterPasswordModal({ isOpen, isSetup }: MasterPasswordModalProps) {
          ...
          >
            <div className="relative overflow-hidden rounded-3xl border border-cyan-500/20 bg-slate-900/80 p-8 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
              ...
              <form onSubmit={handleSubmit} className="relative space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-xl bg-gradient-to-r from-cyan-500 to-emerald-500 py-3 font-semibold text-white shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
                >
                  {isSetup ? (
